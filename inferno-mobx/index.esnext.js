...
const renderReporter = new EventEmitter();
...
export { EventEmitter, Observer, Provider, errorsReporter, inject, observer, onError, renderReporter, trackComponents, useStaticRendering };
